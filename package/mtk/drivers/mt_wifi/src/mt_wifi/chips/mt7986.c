...
#ifndef CONFIG_MT7986_FW_BIN_LOAD
...
#endif /* !CONFIG_MT7986_FW_BIN_LOAD */
 ...
 */
INT8 i1MT7986RxFeLossComp[RAM_BAND_NUM][MAX_ANTENNA_NUM];
...
UINT16 MT7986_PER_CH_A5_BW20_FREQ[] = {
	5180, 5200, 5220, 5240, 5260, 5280, 5300, 5320,
	5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640,
	5660, 5680, 5700, 5720, 5745, 5765, 5785, 5805,
	5825, 5845, 5865, 5885};

UINT16 MT7986_PER_CH_A5_BW160_FREQ[] = {
	5250, 5570, 5815};

UINT16 MT7986_PER_CH_A5_BW20_BW160_FREQ[] = {
	5180, 5200, 5220, 5240, 5260, 5280, 5300, 5320,
	5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640,
	5660, 5680, 5700, 5720, 5745, 5765, 5785, 5805,
	5825, 5845, 5865, 5885,
...
UINT16 MT7986_PER_CH_A5_BW20[] = {
	 36,  40,  44,  48,  52,  56,  60,  64,
	100, 104, 108, 112, 116, 120, 124, 128,
	132, 136, 140, 144, 149, 153, 157, 161,
	165, 169, 173, 177};

UINT16 MT7986_PER_CH_A5_BW160[] = {
	 50, 114, 163};

UINT16 MT7986_PER_CH_A5_BW20_BW160[] = {
	 36,  40,  44,  48,  52,  56,  60,  64,
	100, 104, 108, 112, 116, 120, 124, 128,
	132, 136, 140, 144, 149, 153, 157, 161,
	165, 169, 173, 177,
...
UINT16 MT7986_PER_CH_A6_BW20_FREQ[] = {
...
UINT16 MT7986_PER_CH_A6_BW160_FREQ[] = {
	6025, 6185, 6345, 6505, 6665, 6825, 6985};

UINT16 MT7986_PER_CH_A6_BW20_BW160_FREQ[] = {
	5955, 5975, 5995, 6015, 6035, 6055, 6075, 6095,
	6115, 6135, 6155, 6175, 6195, 6215, 6235, 6255,
	6275, 6295, 6315, 6335, 6355, 6375, 6395, 6415,
	6435, 6455, 6475, 6495, 6515, 6535, 6555, 6575,
...
UINT16 MT7986_PER_CH_A6_BW160[] = {
	 15,  47,  79, 111, 143, 175, 207};

UINT16 MT7986_PER_CH_A6_BW20_BW160[] = {
	  1,   5,   9,  13,  17,  21,  25,  29,
	 33,  37,  41,  45,  49,  53,  57,  61,
	 65,  69,  73,  77,  81,  85,  89,  93,
	 97, 101, 105, 109, 113, 117, 121, 125,
...
UINT16 MT7986_PER_CH_G_BW20_FREQ[] = {
	2422, 2442, 2462};

UINT16 MT7986_PER_CH_G_BW20[] = {
	  3,   7,  11};

UINT16 MT7986_PER_CH_A5_BW20_BW160_FREQ_SIZE = sizeof(MT7986_PER_CH_A5_BW20_BW160_FREQ) / sizeof(UINT16);
UINT16 MT7986_PER_CH_A6_BW20_BW160_FREQ_SIZE = sizeof(MT7986_PER_CH_A6_BW20_BW160_FREQ) / sizeof(UINT16);
UINT16 MT7986_PER_CH_G_BW20_FREQ_SIZE  = (sizeof(MT7986_PER_CH_G_BW20_FREQ) / sizeof(UINT16));

UINT16 MT7986_PER_CH_A5_BW20_BW160_SIZE = sizeof(MT7986_PER_CH_A5_BW20_BW160) / sizeof(UINT16);
UINT16 MT7986_PER_CH_A6_BW20_BW160_SIZE = sizeof(MT7986_PER_CH_A6_BW20_BW160) / sizeof(UINT16);
UINT16 MT7986_PER_CH_A5_BW20_SIZE =  sizeof(MT7986_PER_CH_A5_BW20) / sizeof(UINT16);
UINT16 MT7986_PER_CH_A6_BW20_SIZE =  sizeof(MT7986_PER_CH_A6_BW20) / sizeof(UINT16);

UINT16 MT7986_PER_CH_G_BW20_SIZE    = (sizeof(MT7986_PER_CH_G_BW20) / sizeof(UINT16));
...
void mt7986_apply_dpd_flatness_data(RTMP_ADAPTER *pAd, MT_SWITCH_CHANNEL_CFG SwChCfg)
{
	...
	if (Band == GBAND) 	{/* 2G */
		upper_bound = MT7986_PER_CH_G_BW20_FREQ_SIZE;
		eeprom_ofst = cap->prek_ee_info.dpd_flash_offset_g_begin;
		for (i = 0; i < upper_bound; i++) {
			if (MT7986_PER_CH_G_BW20_FREQ[i] == CentralFreq) {
				MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,
		...
		/* 5G */
		if (SwChCfg.Channel_Band == 1) {
			upper_bound = MT7986_PER_CH_A5_BW20_BW160_FREQ_SIZE;
			eeprom_ofst = cap->prek_ee_info.dpd_flash_offset_a5_begin;
			for (i = 0; i < upper_bound; i++) {
				if (MT7986_PER_CH_A5_BW20_BW160_FREQ[i] == CentralFreq) {
					MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,
						"%d is in DPD-Flatness cal table, index = %d\n",
						CentralFreq, i);
					break;
			...
			upper_bound = MT7986_PER_CH_A6_BW20_BW160_FREQ_SIZE;
			eeprom_ofst = cap->prek_ee_info.dpd_flash_offset_a6_begin;
			for (i = 0; i < upper_bound; i++) {
				if (MT7986_PER_CH_A6_BW20_BW160_FREQ[i] == CentralFreq) {
					MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,
						"%d is in DPD-Flatness cal table, index = %d\n",
						CentralFreq, i);
					break;
	...
	while (ofst < sendNum) {
		MtCmdSetDpdFlatnessCal_7986(pAd, i * sendNum + ofst, PRE_CAL_SET_MAX_LENGTH, eeprom_ofst);
		ofst++;
	}
...
static VOID eep_set_band_select(RTMP_ADAPTER *pAd, PUSHORT *pband_select)
{
#if defined(DOT11_HE_AX) && defined(DBDC_MODE)
	UINT8 i = 0, j = 0, band_idx = 0, boundary_idx = MAX_MULTI_STA, pf_num_idx = 0;
	USHORT tmp_band_select[DBDC_BAND_NUM];
	USHORT band_select_mask = 0;
	UCHAR can_switch = 0, is_write = 0, band_shift = 0;
	struct wifi_dev *wdev;

	if (*pband_select != NULL) {
		/* write back */
		RT28xx_EEPROM_WRITE16(pAd, EEPROM_DBDC_ANTENNA_CFG_OFFSET_B0, (*pband_select)[0]);
		os_free_mem(*pband_select);
		*pband_select = NULL;
		return;
	}

	if (os_alloc_mem(pAd, (UCHAR **)pband_select, DBDC_BAND_NUM * sizeof(USHORT))) {
		MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
		"%s(): allocate memory fail.\n", __func__);
		return;
	}
	os_zero_mem(*pband_select, DBDC_BAND_NUM * sizeof(USHORT));

	RT28xx_EEPROM_READ16(pAd, EEPROM_DBDC_ANTENNA_CFG_OFFSET_B0, (*pband_select)[0]);
	RT28xx_EEPROM_READ16(pAd, EEPROM_DBDC_ANTENNA_CFG_OFFSET_B1, (*pband_select)[1]);


	/* 0x3(11) means 5g and 6g both in the same band and can be switched*/
	for (i = 0 ; i < DBDC_BAND_NUM ; i++) {
		if (((*pband_select)[i] & DBDC_BAND1_SELECT_MASK) >> DBDC_BAND1_SELECT_OFFSET == 0x3)
			can_switch = 1;
		tmp_band_select[i] = (*pband_select)[i];
	}
	...
	for (i = 0; i < boundary_idx; i++) {
		...
		if (wdev) {
			/* rdev is not ready HcGetBandByWdev */
			if (WMODE_CAP_5G(wdev->PhyMode) || WMODE_CAP_6G(wdev->PhyMode))
				band_idx = DBDC_BAND1;
			else
				band_idx = DBDC_BAND0;
			band_shift = (band_idx * 8);

			if (tmp_band_select[band_idx] != 0) {
				/* eeprom layout 00:2g, 01:5g, 10:6g, 11:5g+6g */
				band_select_mask = 0;
				if (WMODE_CAP_6G(wdev->PhyMode)) {
					band_select_mask = 1;
					band_select_mask = band_select_mask << ((DBDC_BAND1_SELECT_OFFSET + 1) + band_shift);
					is_write = 1;
				} else if (WMODE_CAP_5G(wdev->PhyMode)) {
					band_select_mask = 1;
					band_select_mask = band_select_mask << (DBDC_BAND1_SELECT_OFFSET + band_shift);
					is_write = 1;
				}
				if (band_select_mask != 0)
					tmp_band_select[0] = (tmp_band_select[0] & ~(DBDC_BAND1_SELECT_MASK << band_shift)) | band_select_mask;
			}
		}
	}
	if (is_write)
		RT28xx_EEPROM_WRITE16(pAd, EEPROM_DBDC_ANTENNA_CFG_OFFSET_B0, tmp_band_select[0]);

#endif
}
#endif /* CONFIG_6G_SUPPORT */

static UINT32 mt7986_get_sku_decision(RTMP_ADAPTER *ad)
{
	UINT32 reg_val = 0;
	...
	MTWF_PRINT("\033[1;33m sku:0x%x, ADIE=%s \033[0m\n", reg_val,
		(reg_val & MT7986_ADIE_MT7976_TYPE_MASK) ?  "MT7976" : "MT7975");
	return reg_val;
}
...
static struct _kfree_def adie_def_7975[] = {
	...
	{60, {0x7cd, 0x7cf, 0x7d1, 0x7d3, 0x802, 0x803, 0x804, 0x805, 0x806, 0x808,
	      ...
	      0x8c3, 0x8d0, 0x8d1, 0x8d7, 0x8d8, 0x8fa, 0x9a0, 0x9a1, 0x9a5, 0x9a6,
	      0x9a8, 0x9aa, 0x9b0, 0x9b1, 0x9b2, 0x9b3, 0x9b4, 0x9b5, 0x9b6, 0x9b7}
	},
	/* adie1 efuse merge to eeprom offset list */
	{60, {0xe00, 0xe01, 0xe02, 0xe03, 0xe04, 0xe05, 0xe06, 0xe07, 0xe08, 0xe09,
	      0xe0a, 0xe0b, 0xe0c, 0xe0d, 0x80e, 0xe0f, 0xe10, 0xe11, 0xe12, 0xe13,
	      0xe14, 0xe15, 0xe16, 0xe17, 0xe18, 0xe19, 0xe1a, 0xe1b, 0xe1c, 0xe1d,
	      0xe1e, 0xe1f, 0xe20, 0xe21, 0xe22, 0xe23, 0xe24, 0xe25, 0xe26, 0xe27,
	      0xe28, 0xe29, 0xe2a, 0xe2b, 0xe2c, 0xe2d, 0xe2e, 0xe2f, 0xe33, 0xe34,
	      0xe36, 0xe38, 0xe39, 0xe3a, 0xe3b, 0xe3c, 0xe3d, 0xe3e, 0xe3f, 0xe40}
	}
};
...
static struct _kfree_def adie_def_7976[] = {
	...
	/* adie1 efuse merge to eeprom offset list */
	{17, {0x33c, 0x33d, 0x33e, 0x33f, 0x340, 0x341, 0x343, 0x345, 0x347, 0x349,
	      0x359, 0x35a, 0x35d, 0x35e, 0x36a, 0x36c, 0x36e}
	}
...
static BOOLEAN is_cal_free_ic_check(RTMP_ADAPTER *pAd, struct _kfree_def *adie_kfree_def,
	UINT32 adie_offset)
{
	...
	if (!(mt7986_get_sku_decision(pAd) & MT7986_ADIE_MT7976_TYPE_MASK)) {
		/* 7975 A-Die version */
...
static BOOLEAN is_cal_free_ic(RTMP_ADAPTER *pAd)
{
	...
	sku = mt7986_get_sku_decision(pAd);
	if ((sku & MT7986_ADIE_MT7976_TYPE_MASK))
	...
	if (sku & MT7986_ADIE_MT7976_TYPE_MASK) {
		/* MT7976 case */
		UINT32 adie_offset = 0;
		if (sku == ENUM_MT7976_DUAL_ADIE_DBDC) {
			/* merage adie FT */
			adie_offset = MT7986_ADIE1_EFUSE_OFFSET;
		}

		/* 7976 A-Die, To identify MT7976C */
		rtmp_ee_efuse_read16(pAd, 0x270 + adie_offset, &Value);
	...
	ret = is_cal_free_ic_check(pAd, adie_kfree_def, 0);
	if (!ret)
		goto err_out;

	if (sku == ENUM_MT7975_DUAL_ADIE_DBDC || sku == ENUM_MT7976_DUAL_ADIE_DBDC ) {
		ret = is_cal_free_ic_check(pAd, adie_kfree_def, MT7986_ADIE1_EFUSE_OFFSET);
		if (!ret)
			goto err_out;
	}
...
static inline VOID cal_free_data_get_from_addr(RTMP_ADAPTER *ad, UINT16 adie_offset, UINT16 ee_offset)
{
	UINT16 value = 0;

	if ((adie_offset % 2) != 0) {
		rtmp_ee_efuse_read16(ad, adie_offset - 1, &value);
		ad->EEPROMImage[ee_offset] = ((value >> 8) & 0xFF);
	} else {
		rtmp_ee_efuse_read16(ad, adie_offset, &value);
		ad->EEPROMImage[ee_offset] = (value & 0xFF);
	}
	MTWF_DBG(ad, DBG_CAT_HW, DBG_SUBCAT_ALL, DBG_LVL_DEBUG,
		"\t\t adie_offset: 0x%x Replace: 0x%x=0x%02x\n", adie_offset,
		ee_offset, ad->EEPROMImage[ee_offset]);
}
...
static VOID cal_free_data_get(RTMP_ADAPTER *ad)
{
	...
	UINT32 sku = 0;
	UINT8 adie_idx = 0, adie_cnt = 1;
	UINT16 adie_offset = 0;

	MTWF_DBG(ad, DBG_CAT_HW, DBG_SUBCAT_ALL, DBG_LVL_INFO, "\n");

	sku = mt7986_get_sku_decision(ad);
	...
	for (adie_idx = 0; adie_idx < adie_cnt; adie_idx++) {
		if (sku & MT7986_ADIE_MT7976_TYPE_MASK) {
			adie_kfree_def = &adie_def_7976[0];
			ee_kfree_def = &adie_def_7976[adie_idx];
		} else {
			adie_kfree_def = &adie_def_7975[0];
			ee_kfree_def = &adie_def_7975[adie_idx];
		}
		...
		//adie_kfree_def = &adie_def[ad->EEPROMImage[0x9a0]-1];
		kfree_cnt = adie_kfree_def->count;
		for (loop = 0; loop < kfree_cnt; loop++) {
...
static VOID init_mac_cr(RTMP_ADAPTER *pAd)
{
	...
	if (MT7986_get_rid_value() != DEFAULT_RID) {
	...
	EEPROM_ANTENNA_STRUC *pAntenna)
{
	...
	cap->mcs_nss.max_path[DBDC_BAND0][MAX_PATH_TX] = pAd->dbdc_band0_rx_path;
	cap->mcs_nss.max_path[DBDC_BAND0][MAX_PATH_RX] = pAd->dbdc_band0_tx_path;
	...
	cap->mcs_nss.max_path[DBDC_BAND1][MAX_PATH_TX] = pAd->dbdc_band1_rx_path;
	cap->mcs_nss.max_path[DBDC_BAND1][MAX_PATH_RX] = pAd->dbdc_band1_tx_path;
	...
	if (pAd->dbdc_unused_band0) {
		MTWF_DBG(pAd, DBG_CAT_HW, DBG_SUBCAT_ALL, DBG_LVL_ERROR, "%s(): this sku doesn't use 7986 band0 = %d\n",
			__func__, pAd->dbdc_unused_band0);
	}
#endif
}

UINT32 mt7986_get_sub_chipid(RTMP_ADAPTER *ad, UINT32 *sub_chipid)
{
#ifdef DBDC_MODE
	...
	strap_value = mt7986_get_sku_decision(ad);

	switch (strap_value) {
	case ENUM_MT7975_ONE_ADIE_SINGLE_BAND:
	case ENUM_MT7976_ONE_ADIE_SINGLE_BAND:
		/* one adie dbdc */
		*sub_chipid = 0xa;
		break;
	case ENUM_MT7975_DUAL_ADIE_DBDC:
	case ENUM_MT7976_DUAL_ADIE_DBDC:
		/* dual band adie */
		*sub_chipid = 0xf;
		break;
	case ENUM_MT7976_ONE_ADIE_DBDC:
		/* one adie single band */
		*sub_chipid = 0x7;
		break;
	default:
		*sub_chipid = 0xf;
		MTWF_PRINT("\033[1;33m unknown ad_cfg:0x%04x\033[1;0m\n", *sub_chipid);
		break;
	}

	MTWF_PRINT("\033[1;33m ad_cfg:0x%04x\033[1;0m\n", *sub_chipid);
#endif
	return TRUE;
}
...
static VOID fw_prepare(RTMP_ADAPTER *pAd)
{
	...
	UINT32 skus = 0;
	skus = mt7986_get_sku_decision(pAd);
...
#endif /* !CONFIG_MT7986_FW_BIN_LOAD */
	/* default as mt7975 A-Die */
	ctrl->patch_profile[WM_CPU].source.bin_name = MT7986_ROM_PATCH_BIN_FILE_NAME_E1_MT7975;

	if (skus & MT7986_ADIE_MT7976_TYPE_MASK) {
		ctrl->patch_profile[WM_CPU].source.bin_name = MT7986_ROM_PATCH_BIN_FILE_NAME_E1_MT7976;
	}
...
#endif /* !CONFIG_MT7986_FW_BIN_LOAD */
	ctrl->fw_profile[WM_CPU].source.bin_name = MT7986_BIN_FILE_NAME_E1_MT7975;

	if (skus & MT7986_ADIE_MT7976_TYPE_MASK) {
		ctrl->fw_profile[WM_CPU].source.bin_name = MT7986_BIN_FILE_NAME_E1_MT7976;
	}
...
static struct _rx_fe_loss_ee_def rx_fe_def[] = {
		/* adie 7975 */
	{ 0x2fb, 0x2fe, 0x301, 0x304,  /* 2G */
	  0x348, 0x354, 0x360, 0x36c,  /* 5G LB */
	  0x349, 0x355, 0x361, 0x36d,  /* 5G MB */
	  0x34a, 0x356, 0x362, 0x36e  /* 5G LB */
	},
		/* adie 7976 */
	...
	UCHAR path_idx)
{
	...
	if (g_sku == 0)
		g_sku = mt7986_get_sku_decision(pAd);

	if ((g_sku & MT7986_ADIE_MT7976_TYPE_MASK))
		rx_fe_loss_def = &rx_fe_def[1];
	else
	...
	SERV_LOG(SERV_DBG_CAT_ADAPT, SERV_DBG_LVL_INFO,
		("%s: sku:%x, channel:%d, band_idx:%d, ch_band:%d, path_idx:%d\n",
		__func__, g_sku, channel, band_idx, ch_band, path_idx));
...
static UINT32 mt7986_ics_rxv_cmm(
	struct _RTMP_ADAPTER *pAd, UINT8 pktType, UINT8 *pFrameData, UINT8 user_idx, UINT8 band_idx)
{
	UINT8 i;
	RX_STATISTIC_RXV *rx_stat;
	PICS_RX_COMMON_B_FRAME_HEADER_V1 prxCBf = (PICS_RX_COMMON_B_FRAME_HEADER_V1)pFrameData;
	...
	/* pfd */
	//pbuf2 += RXV_DDW0_L;
	rx_stat->pfd = (prxCBf->rxv_c_b[RXV_DDW0_L] & BITS(4, 7)) >> 4;

	/* vht_group_id */
	//pbuf2 = pbuf;
	//pbuf2 += RXV_DDW1_L;
	rx_stat->vht_gid = (prxCBf->rxv_c_b[RXV_DDW1_L] & BITS(22, 27)) >> 22;

	/* rcpi */
	//pbuf2 += RXV_DDW3_L;
	rx_stat->RCPI[0] = (prxCBf->rxv_c_b[RXV_DDW3_L] & BITS(0, 7)) >> 0;
	rx_stat->RCPI[1] = (prxCBf->rxv_c_b[RXV_DDW3_L] & BITS(8, 15)) >> 8;
	rx_stat->RCPI[2] = (prxCBf->rxv_c_b[RXV_DDW3_L] & BITS(16, 23)) >> 16;
	rx_stat->RCPI[3] = (prxCBf->rxv_c_b[RXV_DDW3_L] & BITS(24, 31)) >> 24;
	...
	for (i = WF0; i < WF_NUM; i++) {
		if (rx_stat->RCPI[i] == 0xFF) {
			...
			rx_stat->RCPI[i] = rx_stat->RCPI[i] +
				mt7986_get_rx_fe_loss(pAd, band_idx, i);
#endif
	...
	/* fagc rssi (in-band) */
	//pbuf2 += RXV_DDW3_H;
	rx_stat->FAGC_RSSI_IB[0] = (prxCBf->rxv_c_b[RXV_DDW3_H] & BITS(0, 7)) >> 0;
	rx_stat->FAGC_RSSI_IB[1] = (prxCBf->rxv_c_b[RXV_DDW3_H] & BITS(8, 15)) >> 8;
	rx_stat->FAGC_RSSI_IB[2] = (prxCBf->rxv_c_b[RXV_DDW3_H] & BITS(16, 23)) >> 16;
	rx_stat->FAGC_RSSI_IB[3] = (prxCBf->rxv_c_b[RXV_DDW3_H] & BITS(24, 31)) >> 24;
	for (i = WF0; i < WF_NUM; i++) {
	...
	/* fagc rssi (wide-band) */
	//pbuf2 += RXV_DDW4_L;
	rx_stat->FAGC_RSSI_WB[0] = (prxCBf->rxv_c_b[RXV_DDW4_L] & BITS(5, 12)) >> 5;
	rx_stat->FAGC_RSSI_WB[1] = (prxCBf->rxv_c_b[RXV_DDW4_L] & BITS(14, 21)) >> 14;
	rx_stat->FAGC_RSSI_WB[2] = (prxCBf->rxv_c_b[RXV_DDW4_L] & BITS(23, 30)) >> 23;
	//pbuf2 += RXV_DDW4_H;
	rx_stat->FAGC_RSSI_WB[3] = (prxCBf->rxv_c_b[RXV_DDW4_H] & BITS(0, 7)) >> 0;
	for (i = WF0; i < WF_NUM; i++) {
...
static UINT32 mt7986_ics_rxv_per_user(
	struct _RTMP_ADAPTER *pAd, UINT8 pktType, UINT8 *pFrameData, UINT8 user_idx, UINT8 band_idx)
{
	RX_STATISTIC_RXV *rx_stat;
	PICS_RX_FRAME_0_HEADER_V1 prxf0 = (PICS_RX_FRAME_0_HEADER_V1)pFrameData;
	PICS_RX_FRAME_1_HEADER_V1 prxf1 = (PICS_RX_FRAME_1_HEADER_V1)pFrameData;
	UINT32 foe = 0;

	/* this frame for user 0 only */
	if (pktType == ICS_RX_FRAME_0)
		user_idx = 0;
	...
	/* u4RxMuPktCount */
	if (user_idx == 0)
		rx_stat->rx_mu_ok_cnt[user_idx] += prxf0->fcsOkMpduCount;
	else
		rx_stat->rx_mu_ok_cnt[user_idx] += prxf1->fcsOkMpduCount;

	/* rxv raw data parsing (USR1) */
	rx_stat->rx_vld_ind[user_idx] = (prxf1->rxv_p_b[RXV_DDW0_H] & BIT(31)) >> 31;

	/* rxv raw data parsing (USR2) */
	/* foe */
	//pbuf2 += RXV_DDW0_L;
	foe = 0;
	foe |= (prxf1->rxv_p_a_0[RXV_DDW0_L] & BITS(19, 31)) >> 19;
	//pbuf2 += RXV_DDW0_H;
	foe |= (((prxf1->rxv_p_a_0[RXV_DDW0_H] & BITS(0, 6)) >> 0) << (31-19+1));
	rx_stat->FreqOffsetFromRx[user_idx] = foe;

	//pbuf2 += RXV_DDW0_L;
	/* snr */
	rx_stat->SNR[user_idx] = (prxf1->rxv_p_a_0[RXV_DDW0_L] & BITS(13, 18)) >> 13;
	rx_stat->SNR[user_idx] -= 16;

	/* fcs error */
	//pbuf2 += RXV_DDW0_H;
	rx_stat->fcs_error[user_idx] = (prxf1->rxv_p_a_0[RXV_DDW0_H] & BIT(13)) >> 13;
...
static struct ics_frame_entry _MT7986_ICS_FRAME_SET[] = {
	{0x0, 0, NULL},
	{0x1, 10, NULL},
	{0x2, 30, NULL},
	{0x3, 8, NULL},
	{0x4, sizeof(struct _ICS_RX_COMMON_B_FRAME_HEADER_V1), mt7986_ics_rxv_cmm},
	{0x5, sizeof(struct _ICS_RX_FRAME_0_HEADER_V1), mt7986_ics_rxv_per_user},
	{0x6, sizeof(struct _ICS_RX_FRAME_1_HEADER_V1), mt7986_ics_rxv_per_user},
	{0x7, sizeof(struct _ICS_RX_COMMON_A_FRAME_HEADER_V1), NULL},
	{0x8, 2, NULL},
	{0x9, 22, NULL},
	{0xa, 0, NULL},
	{0xb, 0, NULL},
	{0xc, sizeof(struct _ICS_AGG_HEADER), NULL},
};

static UINT32 mt7986_ics_agg_frame_handler(
	struct _RTMP_ADAPTER *pAd, UINT8 *pFrameData, UINT16 msg_len)
{
	INT16 agg_msg_len = msg_len;
	UINT32 *pdwframe = (UINT32 *)pFrameData;
	UINT8 agg_f_pktType = 0;
	UINT8 *pframe = pFrameData, band_idx = 0;
	struct ics_frame_entry *fentry = NULL;
	...
	while (agg_msg_len > 0) {
		...
		pdwframe = (UINT32 *)pframe;
		agg_f_pktType = (*pdwframe & BITS(27, 31)) >> 27;
		band_idx = (pframe[1] & BIT(7)) >> 7;
		MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_DEBUG,
			"pktType: %x %u, band_idx:%lu\n", agg_f_pktType,
			(pframe[3] & BITS(3, 7)) >> 3, (pframe[1] & BIT(7)) >> 7);

		if (agg_f_pktType > 0 && agg_f_pktType < (sizeof(_MT7986_ICS_FRAME_SET)/sizeof(struct ics_frame_entry))) {
			fentry = &_MT7986_ICS_FRAME_SET[agg_f_pktType];
			if (fentry->handler) {
				fentry->handler(pAd, agg_f_pktType, pframe, fentry->frame_size, band_idx);
			} else {
				MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_DEBUG,
				"%s: \x1b[1;33m no handle this frame:%d \x1b[m \n ", __func__, agg_f_pktType);
			}

			pframe += fentry->frame_size;
			agg_msg_len -= fentry->frame_size;
		} else {
			MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
				"%s: \x1b[1;33m pktType: %x unknown, msg_len: %d \x1b[m \n ",
				__func__, agg_f_pktType, agg_msg_len);
			break;
		}
	}
	...
	IN UINT16 u2Length)
{
	...
	switch (ucPktType) {
	case ICS_AGGREGATION_FRAME:
		prIcsAggHeader = (PICS_AGG_HEADER)GET_OS_PKT_DATAPTR(pucData);
		msg_len = prIcsAggHeader->rxByteCount;
		pData = (UINT8 *)prIcsAggHeader;
		pData += sizeof(struct _ICS_AGG_HEADER);
		msg_len -= sizeof(struct _ICS_AGG_HEADER);

		mt7986_ics_agg_frame_handler(pAd, pData, msg_len);
		break;
	default:
		MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,
			"%s, pktType: %x\n", __func__, ucPktType);
...
static UINT32 mt7986_rxv_entry_parse(struct _RTMP_ADAPTER *pAd, VOID *Data)
{
	...
	for (i = WF0; i < WF_NUM; i++) {
		if (rx_stat->RCPI[i] == 0xFF) {
			...
			rx_stat->RCPI[i] = rx_stat->RCPI[i] + i1MT7986RxFeLossComp[band_idx][i];
			rx_stat->RSSI[i] = (rx_stat->RCPI[i] - 220)/2;
		}
	}
...
static INT32 set_csi_cn_info(RTMP_ADAPTER *pAd, UINT8 u1BandIdx)
{
	INT32 Ret = TRUE;
	/* prepare command message */
	struct _CMD_ATTRIBUTE attr = {0};
	struct cmd_msg *msg = NULL;
	struct _CMD_PHY_STATE_EN_CSI_CN_T param;
	...
	param.u1PhyStateInfoCatg = CMD_PHY_STATE_ENABLE_CSI_CN;
	param.u1Enable = pAd->CommonCfg.EnableCNInfo[u1BandIdx];
	param.u1BandIdx = u1BandIdx;

	MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO,
		"u1Enable = %d, u1BandIdx = %d", param.u1Enable, param.u1BandIdx);
...
static INT32 show_csi_data(RTMP_ADAPTER *pAd, UINT8 u1BandIdx)
{
	INT32 Ret = TRUE;
	/* prepare command message */
	struct _CMD_ATTRIBUTE attr = {0};
	struct cmd_msg *msg = NULL;
	struct _CMD_PHY_STATE_SHOW_CSI_DATA_T param;
	...
	param.u1BandIdx = u1BandIdx;
	param.u1PhyStateInfoCatg = CMD_PHY_STATE_CSI_DATA;
...
VOID mt7986_update_mib_bucket(RTMP_ADAPTER *pAd)
{
	...
	for (i = 0; i < concurrent_bands; i++) {
		if (pAd->MsMibBucket.Enabled == TRUE) {
...
#ifdef CCAPI_API_SUPPORT
			Reg[6].Counter = MIB_CNT_TXOP_INIT; /*TxOpInit Count*/
#endif
			...
			(UINT32)((Reg[6].Value - _prPrevMibCnt->TxOpInitTimeAcc[i])*79);
#endif
...
#ifdef CCAPI_API_SUPPORT
			_prPrevMibCnt->TxOpInitTimeAcc[i] = Reg[6].Value;
#endif
...
VOID mt7986_read_channel_stat_registers(RTMP_ADAPTER *pAd, UINT8 BandIdx, void *ChStat)
{
	RTMP_MIB_PAIR Reg[8];
...
INT32 mt7986_get_default_bin_image_file(RTMP_ADAPTER *ad, RTMP_STRING *path, BOOLEAN fgBinMode)
{
	INT ret;
	UINT32 skus =  0;
	skus = mt7986_get_sku_decision(ad);
	...
	if (skus & MT7986_ADIE_MT7976_TYPE_MASK ) { /* MT7976 case */
		...
		if (skus == ENUM_MT7975_DUAL_ADIE_DBDC) { /* AX6000 */
			ret = snprintf(path, 100, "/lib/firmware/%s", MT7986_EEPROM_BIN_FILE_NAME_AX6000_MT7975);
		} else if (skus == ENUM_MT7975_ONE_ADIE_SINGLE_BAND) { /* AX7800 */
			ret = snprintf(path, 100, "/lib/firmware/%s", MT7986_EEPROM_BIN_FILE_NAME_AX7800_MT7975); /* TODO : may have AX7800 EEPROM or use AX6000 EEPROM */
		} else {/* fill default  */
			ret = snprintf(path, 100, "%s", EEPROM_DEFAULT_FILE_PATH);
			MTWF_PRINT("\x1b[41m unknown of MT7975!!\x1b[m\n");
		}
	}
	...
	IN PUCHAR		pBuf)
{
	...
	if (tx_nss > 4) {
		...
		if (he_bw == HE_BW_160 || he_bw == HE_BW_8080) {
			...
			MTWF_PRINT(
				"Psi84 = 0x%02x, Phi74 = 0x%03x, Psi74 = 0x%02x, Phi64 = 0x%03x\n"
				"jji75 = 0x%02x, Phi65 = 0x%03x, Psi65 = 0x%02x, Phi55 = 0x%03x\n",
	...
	if (txbf_status->cmmCfgETxBfEnCond > 0) {
		...
		case SUBF_ALL:
			...
			if (he_bf_struct->bf_cap & HE_SU_BFER) {
				...
				* Our current HW's Nsts of '<=BW80' and Nsts of '>BW80' will
				* follow SKU's spec.
				*/
				he_bf_struct->snd_dim_gt_bw80 = wlan_config_get_tx_stream(wdev) - 1;
...
static BOOLEAN hif_wait_WFDMA_idle(struct _RTMP_ADAPTER *pAd, UINT8 pcie_port_or_all, INT round, INT wait_us)
{
	...
	/* configure PCIe 1 host dma if it's in use, check if recognition ID is written */
	if ((MT7986_get_rid_value() != DEFAULT_RID) && (band_idx_map & (1 << 1))) {
...
#define MAX_RETRY_CNT 4
	...
	do {
		...
		if (drv_own)
			...
			MTWF_DBG(ad, DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_INFO, "fail to clear p=%d fw_own\n", port_idx);
...
static VOID mt7986_multi_isr(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
	struct _RTMP_ADAPTER *pAd = RTMP_OS_NETDEV_GET_PRIV(pci_hif->net_dev);
...
static VOID mt7986_multi_isr_2nd(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
	struct _RTMP_ADAPTER *pAd = RTMP_OS_NETDEV_GET_PRIV(pci_hif->net_dev);
...
static VOID mt7986_multi_isr_3rd(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
	struct _RTMP_ADAPTER *pAd = RTMP_OS_NETDEV_GET_PRIV(pci_hif->net_dev);
...
static VOID mt7986_multi_isr_4th(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
	struct _RTMP_ADAPTER *pAd = RTMP_OS_NETDEV_GET_PRIV(pci_hif->net_dev);
...
static VOID mt7986_isr_pcie1(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
	struct _RTMP_ADAPTER *pAd = RTMP_OS_NETDEV_GET_PRIV(pci_hif->net_dev);
...
static VOID mt7986_isr_merge(struct pci_hif_chip *hif_chip)
{
	UINT8 i;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
...
{
	UINT8 bandIdx = 0, txrx = 0;

#ifdef G_BAND_256QAM
	mcs_nss->g_band_256_qam = TRUE;
#endif
	for (bandIdx = 0; bandIdx < BAND_NUM; bandIdx++) {
		mcs_nss->max_nss[bandIdx] = 4;
		for (txrx = 0; txrx < 2; txrx++)
			mcs_nss->max_path[bandIdx][txrx] = 4;
	}
...
#ifdef WF_RESET_SUPPORT
static void mt7986_do_wifi_reset(RTMP_ADAPTER *ad)
{
...
*
*/
static VOID mt7986_hif_chip_match(VOID *hdev_ctrl)
{
...
*
*/
static VOID mt7986_hif_pci_data_ring_assign(VOID *hdev_ctrl, UINT8 *resrc_idx)
{
	struct _PCI_HIF_T *pci_hif = hc_get_hif_ctrl(hdev_ctrl);
...
*
*/
static VOID mt7986_hif_pci_slave_chip_defer_create(VOID *hdev_ctrl)
{
	struct _PCI_HIF_T *pci_hif = hc_get_hif_ctrl(hdev_ctrl);
	...
	if (pci_hif &&
		...
		(IS_ASIC_CAP(pAd, fASIC_CAP_DUAL_PCIE_ONE_PROBE)))
	{
		struct pci_hif_chip *main_hif_chip = pci_hif->main_hif_chip;
		struct pci_hif_chip *slave_hif_chip;
		struct pci_hif_chip_cfg slave_cfg;

		if (MT7986_get_rid_value() != DEFAULT_RID)
			return;

		if (main_hif_chip != NULL) {
			memcpy(&slave_cfg, &main_hif_chip->cfg, sizeof(main_hif_chip->cfg));
			slave_cfg.device_id = FAKE_PCIE1_CHIP_ID;
			if (pci_hif_chip_init((VOID **)&slave_hif_chip, &slave_cfg) != NDIS_STATUS_SUCCESS) {
				MTWF_DBG(pAd, DBG_CAT_HIF, CATHIF_PCI, DBG_LVL_ERROR, "Fail to create deferred slave hif chip!\n");
				return;
			} else {
				MTWF_PRINT("Success to create deferred slave hif chip!\n");
			}
		}
	}
}
...
static VOID mt7986_dump_ser_stat(RTMP_ADAPTER *pAd, UINT8 dump_lvl)
{
	...
	for (i = 0; i < MURU_MAX_GROUP_CN; i++)	{
		...
		for (j = 0; j < MURU_MUM_MAX_PFID_NUM; j++)	{
			if (u4TotalCount[i][j] == 0)
				...
				MTWF_PRINT("\t %u", ((u4TotalCount[i][j] - u4SuccessCount[i][j] * 100) / u4TotalCount[i][j]));
		}
	}
...
INT32 mt7986_get_RxFELossComp_data(struct _RTMP_ADAPTER *pAd, VOID *pData)
{
	P_EVENT_PHY_RXFELOSS_T prFeLossComp;
	UINT8 u1AntIdx = 0;

	prFeLossComp = (P_EVENT_PHY_RXFELOSS_T)pData;

	if ((prFeLossComp != NULL) && (prFeLossComp->u1BandIdx < RAM_BAND_NUM)) {

		for (u1AntIdx = 0; u1AntIdx < MAX_ANTENNA_NUM; u1AntIdx++) {
			i1MT7986RxFeLossComp[prFeLossComp->u1BandIdx][u1AntIdx] = prFeLossComp->i1FeLossComp[u1AntIdx];
		}
	}
 ...
 */
static VOID mt7986_txd_post_process(struct _RTMP_ADAPTER *pAd, UCHAR *tmac_info, MAC_TX_INFO *info, HTTRANSMIT_SETTING *pTransmit)
{
 ...
 */
static VOID mt7986_post_config_hif(struct _RTMP_ADAPTER *pAd)
{
#ifdef MULTI_INTR_SUPPORT
...
static VOID mt7986_update_chip_cap(RTMP_ADAPTER *ad)
{
...
static VOID mt7986_chipCap_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_CAP *chip_cap)
{
	...
	chip_cap->DbdcOneBand1Support = TRUE;
#endif
#endif
#ifdef WHNAT_SUPPORT
	...
	chip_cap->phy_caps = (fPHY_CAP_24G | fPHY_CAP_5G | fPHY_CAP_6G |
			...
			fPHY_CAP_BW40 | fPHY_CAP_BW80 | fPHY_CAP_BW160C | \
	...
	chip_cap->EEPROM_DEFAULT_BIN_SIZE = sizeof(MT7986_E2PImage);
	chip_cap->EFUSE_BUFFER_CONTENT_SIZE = sizeof(MT7986_E2PImage);
...
#ifdef DOT11_HE_AX
#ifdef WIFI_TWT_SUPPORT
	chip_cap->twt_hw_num = MT7986_TWT_HW_AGRT_MAX_NUM;
	chip_cap->twt_btwt_max_num = MT7986_TWT_HW_BTWT_MAX_NUM;
	chip_cap->twt_group_max_num = MT7986_TWT_HW_GRP_MAX_NUM;
	chip_cap->twt_individual_max_num = (chip_cap->twt_hw_num - chip_cap->twt_btwt_max_num - chip_cap->twt_group_max_num);
	chip_cap->twt_sp_duration_min_num = MT7986_TWT_SP_DURATION_MIN_NUM;
#endif /* WIFI_TWT_SUPPORT */
	...
	chip_cap->prek_ee_info.cal_result_size + chip_cap->prek_ee_info.cal_result_size_5g + chip_cap->prek_ee_info.cal_result_size_adcdcoc;
	chip_cap->prek_ee_info.pre_cal_total_size_7976 =
	chip_cap->prek_ee_info.cal_result_size + chip_cap->prek_ee_info.cal_result_size_6g + chip_cap->prek_ee_info.cal_result_size_adcdcoc;

	/* DPD & Flatness item */
	chip_cap->prek_ee_info.per_ch_cal_size = 3 * 1024;
	chip_cap->prek_ee_info.per_ch_6g_num = MT7986_PER_CH_A6_BW20_BW160_SIZE;
	chip_cap->prek_ee_info.per_ch_5g_num = MT7986_PER_CH_A5_BW20_BW160_SIZE;
	chip_cap->prek_ee_info.per_ch_2g_num = MT7986_PER_CH_G_BW20_SIZE;
	...
	chip_cap->prek_ee_info.dpd_flash_offset_7976 = CAL_FLASH_OFFSET + chip_cap->prek_ee_info.pre_cal_total_size_7976;
	...
	chip_cap->rxgaincal_ofst = 0x539;
	chip_cap->rxgaincal_ofst_7976 = 0xE00;
}
...
static VOID mt7986_chipCap_post_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_CAP *chip_cap)
{
	...
	chip_cap->eeprom_sku = mt7986_get_sku_decision(pAd);
	/* Add for eeprom */
	if (chip_cap->eeprom_sku & (MT7986_ADIE_MT7976_TYPE_MASK)) {
		chip_cap->prek_ee_info.pre_cal_total_size = chip_cap->prek_ee_info.pre_cal_total_size_7976;
...
static void mt7986_eeprom_info_extract(RTMP_ADAPTER *pAd, VOID *eeprom)
{
/* enable it when SB */
}
...
#ifdef DBDC_MODE
static UCHAR MT7986BandGetByIdx(RTMP_ADAPTER *pAd, UCHAR BandIdx)
{
	switch (BandIdx) {
	case 0:
		return (RFIC_24GHZ);
...
#ifdef WF_RESET_SUPPORT
static VOID mt7986_heart_beat_check(struct _RTMP_ADAPTER *pAd)
{
...
#define WM_HANG_COUNT_CHECK 9
	...
	if ((pAd->Mlme.PeriodicRound % HEART_BEAT_CHECK_PERIOD) == 0) {
		WLAN_HOOK_CALL(WLAN_HOOK_HB_CHK, pAd, &stop);
		if (stop) {
			MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, "wo heart beat stop!");
			pAd->wf_reset_wo_count++;
...
static VOID mt7986_hw_auto_debug(RTMP_ADAPTER *pAd)
{
...
static VOID mt7986_hw_auto_debug_trigger
...
#ifdef DOT11_VHT_AC
static INT mt7986_set_rts_signal_ta(RTMP_ADAPTER *ad, UINT8 band_idx, BOOLEAN enable)
{
...
static VOID mt7986_chipOp_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_OP *chip_op)
{
...
#ifdef CONFIG_6G_SUPPORT
	chip_op->eep_set_band_sel = eep_set_band_select;
#endif /* CONFIG_6G_SUPPORT */
#ifdef CONFIG_STA_SUPPORT
...
#endif
#ifdef DBDC_MODE
	chip_op->BandGetByIdx = MT7986BandGetByIdx;
#endif
#ifdef DOT11_HE_AX
#ifdef WIFI_TWT_SUPPORT
	...
	chip_op->hif_pci_data_ring_assign = mt7986_hif_pci_data_ring_assign;
	chip_op->hif_pci_slave_chip_defer_create = mt7986_hif_pci_slave_chip_defer_create;
...
#endif /*SCS_FW_OFFLOAD*/
#endif /*SMART_CARRIER_SENSE_SUPPORT*/
	chip_op->get_RxFELossComp_data = mt7986_get_RxFELossComp_data;
...
#ifdef WIFI_CSI_CN_INFO_SUPPORT
	chip_op->set_csi_cn_info = set_csi_cn_info;
	chip_op->show_csi_data = show_csi_data;
#endif /* WIFI_CSI_CN_INFO_SUPPORT */
	chip_op->txpower_show_info = mtf_txpower_show_info;
	chip_op->update_mib_bucket = mt7986_update_mib_bucket;
#ifdef OFFCHANNEL_ZERO_LOSS
	chip_op->read_channel_stat_registers = mt7986_read_channel_stat_registers;
#endif
...
#endif
	chip_op->post_config_hif = mt7986_post_config_hif;
	chip_op->update_chip_cap = mt7986_update_chip_cap;
	chip_op->get_sub_chipid = mt7986_get_sub_chipid;
#ifdef WF_RESET_SUPPORT
	chip_op->heart_beat_check = mt7986_heart_beat_check;
	chip_op->do_wifi_reset = mt7986_do_wifi_reset;
#endif
	chip_op->hw_auto_debug_check = mt7986_hw_auto_debug;
	chip_op->hw_auto_debug_trigger = mt7986_hw_auto_debug_trigger;
#ifdef CONNAC_EFUSE_FORMAT_SUPPORT
	chip_op->eeprom_extract = mt7986_eeprom_info_extract;
#endif /* CONNAC_EFUSE_FORMAT_SUPPORT */
#ifdef WIFI_RAM_EMI_SUPPORT
	chip_op->parse_emi_phy_addr = mt7986_parse_emi_phy_addr;
#endif /* WIFI_RAM_EMI_SUPPORT */
	chip_op->get_rid_value = MT7986_get_rid_value;
...
static VOID mt7986_archOp_init(RTMP_ADAPTER *ad, RTMP_ARCH_OP *arch_ops)
{
	...
	arch_ops->archSetWcidSN = MtAsicUpdateStaRecSNByFw;
...
#endif /*MAC_INIT_OFFLOAD*/
#ifdef DOT11_VHT_AC
	arch_ops->archSetRtsSignalTA = mt7986_set_rts_signal_ta;
#endif /*  DOT11_VHT_AC */
	...
	arch_ops->archMcastConfigAgeout = IgmpSetAgeOutTime;
	arch_ops->archMcastGetMcastTable = IgmpGetMcastEntryTable;
...
#endif
	arch_ops->txd_post_process = mt7986_txd_post_process;
...
#ifdef VLAN_SUPPORT
	/* vlan2eth E2 has side effect, default disable */
	if (MTK_REV_GTE(pAd, MT7986, MT7986E2))
...
VOID mt7986_hif_ctrl_chip_init(VOID *hif_chip)
{
	...
	hif->isr = mt7986_isr;
#ifdef MULTI_INTR_SUPPORT
	hif->multi_isr = mt7986_multi_isr;
	hif->multi_isr_2nd = mt7986_multi_isr_2nd;
	hif->multi_isr_3rd = mt7986_multi_isr_3rd;
	hif->multi_isr_4th = mt7986_multi_isr_4th;
#endif
#else
	hif->isr = mt7986_isr_merge;
	hif->isr_handler = mt7986_isr;
#endif /* RTMP_RBUS_SUPPORT */
...
#ifdef RTMP_RBUS_SUPPORT
	hif->isr = mt7986_isr_pcie1;
#else
	hif->isr = mt7986_isr_merge;
	hif->isr_handler = mt7986_isr_pcie1;
#endif /* RTMP_RBUS_SUPPORT */
