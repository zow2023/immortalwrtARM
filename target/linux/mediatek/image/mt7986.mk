...
define Device/tplink_tl-common
   ...
   DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
   DEVICE_PACKAGES :=luci-app-mtk l1profile wireless-tools kmod-conninfra kmod-warp kmod-mt_wifi automount ipv6helper kmod-mediatek_hnat bash autocore-arm mtkhqos_util kmod-usb3 wifi-profile
   UBINIZE_OPTS := -E 5
   BLOCKSIZE := 128k
   PAGESIZE := 2048
   KERNEL_IN_UBI := 1
